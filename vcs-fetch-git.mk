...
# Description: Convenience rules for creating upstream tarballs from git
#
...
# tarball from an upstream git server.  Note that this MUST come before
...
ifndef _cdbs_rules_vcs_fetch_git
_cdbs_rules_vcs_fetch_git = 1

_debug_variables := GIT_UPSTREAM_REVISION
...
$(git_stamps):
	git clone $(src_uri) $(VCS_TARBALL_WORKDIR)
	$(if $(GIT_UPSTREAM_REVISION),cd $(VCS_TARBALL_WORKDIR) && git checkout $(GIT_UPSTREAM_REVISION))
	rm -rf $(VCS_TARBALL_WORKDIR)/.git/
...
endif #_cdbs_rules_vcs_fetch_git
